...
<nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
    <div class="sidebar-inner px-4 pt-3">
        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            ...
            <!-- Menu Dashboard -->
            <li class="nav-item {{ request()->routeIs('dashboard') || request()->is('dashboard') ? 'active' : '' }}">
            ...
            <!-- Menu Pelanggan -->
            <li class="nav-item {{ request()->routeIs('pelanggan.*') || request()->is('pelanggan*') ? 'active' : '' }}">
            ...
            <!-- Menu User -->
            <li class="nav-item {{ request()->routeIs('user.*') || request()->is('user*') ? 'active' : '' }}">
